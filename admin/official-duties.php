...
include 'fetch-official-duties.php';
?>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 p-4">
            <div class="container mt-4">
                    ...
                    <div class="col-md">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-text text-secondary">2</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <h3>Officials Record</h3>
                    <div class="d-flex justify-content-between mb-3">
                        <!-- Search Box -->
                        <div class="row">
                            <div class="col">
                                <input type="text" id="search-officials-input" class="form-control" placeholder="Search by name"
                        ...
                        <div class="flex-end">
                            <a class="btn btn-success" id="export-csv" href="#">
                                XLSX</a>
                            <a class="btn btn-primary" id="export-pdf" href="#">
                                PDF</a>
                        </div>
